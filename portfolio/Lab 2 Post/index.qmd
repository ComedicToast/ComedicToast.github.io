...
crosstabs <- read_excel(here("portfolio", "Lab 2 Post" ,"wgm2018.xlsx"), sheet=1, skip=2)
full_data <- read_excel(here("portfolio", "Lab 2 Post" ,"wgm2018.xlsx"), sheet=2)
dictionary <- read_excel(here("portfolio", "Lab 2 Post" ,"wgm2018.xlsx"), sheet=3)
#this is cleaned data for q1 specifically
cleaned <- read.csv(here("portfolio", "Lab 2 Post" ,"wgm_cleaned.csv"))
...
# Load GeoJSON
WorldCountry <- st_read(here("portfolio", "Lab 2 Post" ,"countries.geo.json"))
